...
import pkp.faisal.fintech.activity.PengajuanActivity;
...
public class DashboardFragment extends Fragment implements View.OnTouchListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        view.findViewById(R.id.ajukanBtn).setOnTouchListener(this);
    ...
    private void ajukanBtn() {
        startActivity(new Intent(getContext(), PengajuanActivity.class));
    }
}
